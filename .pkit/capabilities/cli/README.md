...
- **[`output-discipline.md`](output-discipline.md)** — the spec: the event model, the vocabulary, the renderer contract, selection, and the invariants. Governed by [ADR-053](../../../docs/architecture/decisions/ADR-053-cli-output-discipline.md).
