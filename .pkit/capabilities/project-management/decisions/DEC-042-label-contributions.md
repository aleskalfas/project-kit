...
- **Extraction (COR-007).** The shared manifest-walked, orphan-safe contribution-collector core is extracted into pm's `_lib/`, with review-contributions reinstantiated on it and label-contributions built on it; DEC-030's walker is noted as a later refactor target. The extraction and its severity/malformed-disposition rule are pinned in a sibling ADR (authored with this work). Refactoring review-contributions' realization is behaviour-preserving.
...
- **Stands on** DEC-030, DEC-032, COR-007, COR-014, COR-026, COR-030, ADR-026 — all accepted — and the sibling ADR extracting the collector, authored alongside.
