...
def main() -> int:
    parser = argparse.ArgumentParser(description="Detect whether an issue is in the 'review' lifecycle state.")
    ...
    if not bootstrap_gate.enforce("detect-review"):
        return 2
    ...
    payload = predicates.detect_state(issue_number, 'review')
