...
# ]
# ///
"""Project-management capability — detect-in-progress (process predicate, DEC-032).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Detect whether an issue is in the 'in-progress' lifecycle state.")
