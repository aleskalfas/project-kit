...
- **Privacy footprint.** The diagnostic log is a new local artifact carrying redacted command strings; it is git-ignored via the merge primitive and size-capped. The redaction-on-by-default and ignore must ship with capture, not after.
