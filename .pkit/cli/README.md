...
Every refusal's suggested remedy is one the same invocation accepts: where a refusal names a command, running it from where you stand gets past that refusal.
