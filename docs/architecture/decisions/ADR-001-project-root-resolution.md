...
- **An override can be added later** — a flag, an environment variable, or a marker file — as a non-breaking extension ahead of the implicit default. The implicit-from-cwd contract is the floor.
