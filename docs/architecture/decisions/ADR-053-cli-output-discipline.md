...
- **Placement.** The pkit binding stays tool-internal (not propagated) until the `cli` capability extraction; the spec doc lives at `docs/cli-output-discipline.md` now and lifts into the capability at extraction.
